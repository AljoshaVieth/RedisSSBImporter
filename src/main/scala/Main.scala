...
import de.aljoshavieth.redisssbinserter.alternative_structures.denormalized.InsertWithDenormalizedStructure
...
object Main {
	def main(args: Array[String]): Unit = {
		...
		val jedis = new Jedis("localhost", 6382)
		val jedisPooled = new JedisPooled("localhost", 6382)
